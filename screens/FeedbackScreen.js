...
export default class FeedbackScreen extends Component {
  ...
  componentDidMount() {
    const myitems = firebase.database().ref('feedBack');
  ...
  saveItem() {
    ...
    const myFeedback = firebase.database().ref('feedBack');
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={Styles.viewInput2}>
          <TextInput
            placeholder="Gõ phản hồi tại đây !"
            placeholderTextColor="#239dad"
            style={{fontWeight: 'bold', fontSize: 13, width: 255}}
        ...
        <View style={{margin: 20}}>
          <Button
            style={{backgroundColor: 'coral', width: '80%', margin: 30}}
